...
namespace NINA.StarMessenger.Communication.Trigger.Email
{
    ...
    public class SendStarMessageToEmailByConditionTrigger : SequenceTrigger, IValidatable
    {
        ...
        private static bool IsAimedConsecutiveCountReached(Condition<SendStarMessageToEmailByConditionTrigger> currentCondition)
        {
        ...
        private static bool IsConditionCheckedByOperatorFullfilled(object actualValueParsed, object expectedValueParsed, Condition<SendStarMessageToEmailByConditionTrigger> currentCondition)
        {
